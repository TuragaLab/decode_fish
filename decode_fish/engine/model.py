...
__all__ = ['init_func', 'number_of_features_per_level', 'create_conv', 'SingleConv', 'DoubleConv', 'Upsampling',
           'Encoder', 'Decoder', 'Abstract3DUNet', 'UNet3D', 'IntensityDist', 'OutputNet', 'UnetDecodeNoBn']
...
class UnetDecodeNoBn(nn.Module):
    def __init__(self, ch_in=1, ch_out=10, final_sigmoid=False, depth=3, inp_scale=1., inp_offset=0., order='bcr', f_maps=64, p_offset=-5.,
